		...
		<section class="py-5">
			...
			<div class="container px-4 px-lg-5 mt-5">
				<table align=center>
					...
					<tr><td align=center colspan=2><input type=button id=login value="로그인" class="btn btn-outline-dark">&nbsp;&nbsp;
					...
					<input type=button id=SignUp value="회원가입" class="btn btn-outline-dark"></td></tr>
				</table>
			</div>
